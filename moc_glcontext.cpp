...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GLContext_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GLContext_t qt_meta_stringdata_GLContext = {
    {
QT_MOC_LITERAL(0, 0, 9), // "GLContext"
QT_MOC_LITERAL(1, 10, 11), // "timerUpdate"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "GLContext\0timerUpdate\0"
};
...
void GLContext::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GLContext *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GLContext::staticMetaObject = { {
    QMetaObject::SuperData::link<QOpenGLWidget::staticMetaObject>(),
    qt_meta_stringdata_GLContext.data,
    qt_meta_data_GLContext,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GLContext::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GLContext.stringdata0))
